...
function LandingPage({
    ...
    const translations: Translations = {
        [Language.English]: [
            'Welcome to Musictranspositor.com!',
            'Musictranspositor.com is an online transposer tool that allows you to easily transpose a single note from one key to another.',
            <>
        ...
        [Language.French]: [
            'Bienvenue sur Musictranspositor.com!',
            "Musictranspositor.com est un outil en ligne de transposition musicale qui vous permet de transposer facilement une note d'une tonalité à une autre.",
            <>
        ...
        [Language.Spanish]: [
            'Bienvenido a Musictranspositor.com!',
            'Musictranspositor.com es una herramienta en línea de transposición musical que te permite transponer fácilmente una nota de una tonalidad a otra.',
            <>
        ...
        [Language.German]: [
            'Willkommen bei Musictranspositor.com!',
            'Musictranspositor.com ist ein Online-Transpositionswerkzeug, mit dem Sie einfach eine Note von einer Tonart in eine andere transponieren können.',
            <>
